...
class UniversalAdapter(DockerizedAdapter):
    ...
    def __init__(self, definition: Optional[Dict[str, Any]] = None):
        ...
        image_str = self.definition.get("uses", "alpine:latest") # Default to alpine if empty
        ...
        try:
            ...
            if not image_str:
                ...
                if self.docker_image and self.docker_image != "alpine:latest":
                    ...
                    raise ValueError("No Docker image specified (missing 'uses' in inputs or definition)")
