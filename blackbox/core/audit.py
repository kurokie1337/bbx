...
class AuditLogger:
    ...
    def log_execution(
        ...
        self.logger.info(f"Audit: {adapter_id} - {'✅' if success else '❌'} - {duration_ms:.0f}ms")
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        avg_duration = sum(e.duration_ms for e in all_entries) / total if total > 0 else 0
        ...
        return {
            ...
            "most_used": sorted(adapter_counts.items(), key=lambda x: x[1], reverse=True)[:5]
        }
