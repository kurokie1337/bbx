...
class HealthChecker:
    ...
    def check_docker() -> Dict[str, Any]:
        ...
        try:
            ...
            if result.returncode == 0:
                return {"status": "healthy", "message": "Docker daemon running"}
            else:
                return {
                    "status": "unhealthy",
            ...
            return {"status": "unhealthy", "message": "Docker check timed out"}
        except FileNotFoundError:
            return {"status": "unhealthy", "message": "Docker not installed"}
        except Exception as e:
            return {"status": "unhealthy", "message": f"Docker check failed: {str(e)}"}
    ...
    def check_packages() -> Dict[str, Any]:
        ...
        try:
            ...
            return {"status": "healthy", "message": "All core packages available"}
        except ImportError as e:
            return {"status": "unhealthy", "message": f"Missing package: {str(e)}"}

    @staticmethod
    def liveness() -> Dict[str, Any]:
        """Basic liveness check."""
        return {"status": "alive", "message": "BBX system is running"}
    ...
    def readiness() -> Dict[str, Any]:
        ...
        all_healthy = all(
            check.get("status") in ["alive", "healthy"] for check in checks.values()
        )
